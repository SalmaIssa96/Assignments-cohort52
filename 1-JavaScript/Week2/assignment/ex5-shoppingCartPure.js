...
------------------------------------------------------------------------------*/
// ! Function under test
function addToShoppingCart(initialShoppingCart, item) {
  if (item) {
    if (initialShoppingCart.length === 3) {
      return [...initialShoppingCart, item].slice(1);
    } else {
      return [...initialShoppingCart, item];
    }
  }
}
